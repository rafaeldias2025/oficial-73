...
export function useHealthIntegration() {
  ...
  return {
    ...
    isGoogleFitAvailable: () => !!window.gapi,
    isAppleHealthAvailable: () => false, // Web não suporta Apple Health
    connectGoogleFit,
    connectAppleHealth: async () => false, // Web não suporta
    syncGoogleFitData,
    syncAllData: syncGoogleFitData,
    disconnectGoogleFit,
    disconnect: disconnectGoogleFit,
    saveUserConfig,
    checkConnectionStatus,
    loadConfiguration: loadUserConfig
  };
}