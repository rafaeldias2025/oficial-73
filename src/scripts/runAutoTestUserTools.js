...
var autoTestUserTools_1 = require("@/utils/autoTestUserTools");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var user, userId, profile, profileId, challenge, challengeId, result;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .maybeSingle()];
                case 3:
                    challenge = (_a.sent()).data;
                    if (!challenge) {
                        console.error('Nenhum desafio encontrado.');
                        return [2 /*return*/];
                    }
                    challengeId = challenge.id;
                    return [4 /*yield*/, (0, autoTestUserTools_1.autoTestUserTools)(userId, profileId, challengeId)];
                case 4:
                    result = _a.sent();
