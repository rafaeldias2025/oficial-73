      ...
      <Card className="border-0 bg-gradient-to-br from-background via-muted/30 to-background shadow-xl">
        ...
        <CardContent className="space-y-6">
          ...
          {progresso >= 100 && (
            <FeedbackPontuacao 
              pontuacao={{
                total: pontuacaoCalculada.total,
                maxima: 30,
                showDetalhes: true
              }}
            />
          ...
          <div className="text-center p-6 bg-primary/10 rounded-lg">
            <p className="text-lg italic text-foreground/80 mb-4">
              "{getFeedbackPontuacao(pontuacaoCalculada.total, 'detalhado').mensagem}"
            </p>
            <Badge variant="secondary" className="text-sm">
              {getFeedbackPontuacao(pontuacaoCalculada.total, 'detalhado').emoji} {pontuacaoCalculada.total} pontos hoje
            </Badge>
          </div>
